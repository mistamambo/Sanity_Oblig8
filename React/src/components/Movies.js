                ...
                return (
                    <div className="flex flex-row-2 justify-center gap-2 p-3 mb-5">
                        <article key={movieList.title} className="text-lg font-bold mt-3">
                            ...
                            <img src={movieList} className=" max-w-sm mb-3 round rounded-t-lg " ></img>
                            <button><Link to={movieList} className="bg-orange-500 text-sm text-blue-50 py-2 px-2 rounded-lg" >Movie Info</Link></button>
                        </article>
                    </div>
                )
            }) : null}
